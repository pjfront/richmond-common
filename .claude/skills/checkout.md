...
5. Git — All changes committed, feature branch merged to main, and pushed to GitHub. Merge to main is the default unless there's an explicit reason not to (broken tests, intentionally incomplete work, operator says to leave it).
