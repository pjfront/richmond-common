...
1. **Multi-city orchestration:** Extract Richmond-specific hardcoding (32 locations across 13 files) into a city config registry (`src/city_config.py`). Each scraper/client accepts city config instead of module-level constants. Adding a new city = adding a dict entry. Plan: `docs/plans/2026-02-22-multi-city-orchestration-plan.md`.
