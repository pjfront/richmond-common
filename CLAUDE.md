...
| **S9** | Scanner v3: Signal Architecture | ✅ S9.1-S9.2: RawSignal + composite confidence + signal detectors. Remaining: temporal integration, donor-vendor cross-reference, batch rescan, frontend labels |
