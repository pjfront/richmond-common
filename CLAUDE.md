...
1. **Cloud pipeline infrastructure (Phases B–E remaining):** Phase A (core infrastructure) complete. Remaining: Phase B — n8n Cloud webhook integration + scheduled triggers. Phase C — NextRequest/CPRA document ingestion. Phase D — data freshness monitoring dashboard. Phase E — multi-city orchestration. Spec: `docs/specs/cloud-pipeline-spec.md`.
