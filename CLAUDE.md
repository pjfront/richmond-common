...
| **S18** | Go Live (richmondcommons.org) | In progress. ✅ Security headers (HSTS, X-Frame-Options, Permissions-Policy), version bump 1.0.0, visual sweep. **Remaining:** S18.1 domain DNS (7 domains on Cloudflare, email forwarding) — human action. S18.3 OG image — judgment call. |
