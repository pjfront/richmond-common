...
| **S17B** | Election Cycle Accuracy | Populate election_candidates from NetFile, scope donation cycle filters to official's actual elections, election history on profiles (terms, expiration, filing status) |
