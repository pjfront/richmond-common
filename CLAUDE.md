...
| **S9** | Scanner v3: Signal Architecture | ✅ S9.1-S9.3: RawSignal + composite confidence + signal detectors + temporal integration + donor-vendor cross-reference + corroboration grouping. Remaining: DB mode parity, batch rescan, frontend labels |
