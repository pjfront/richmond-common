"""Keep merged S29 discovery code dark throughout the measured baseline."""
...
def test_release_record_holds_the_reviewed_discovery_merges() -> None:
    phase = _phase()
...
def test_source_flag_matches_the_baseline_record() -> None:
    source = FLAG_PATH.read_text(encoding="utf-8")
    assert "S29_PUBLIC_TREATMENT_ENABLED: boolean = false" in source
