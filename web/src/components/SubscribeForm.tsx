  ...
  return (
    ...
    >
      <p role="status" aria-live="polite" className="sr-only">
        {status === 'submitting' ? 'Submitting your subscription.' : ''}
      </p>
      {!compact && (
        <div>
      ...
      <div className={compact ? 'flex gap-2' : ''}>
        ...
        {compact && (
          <button
            ...
            className="min-h-11 whitespace-nowrap rounded-md bg-civic-navy px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-civic-navy-light focus:outline-none focus:ring-2 focus:ring-civic-navy focus:ring-offset-2 disabled:cursor-wait disabled:opacity-50 cursor-pointer"
          >
      ...
      {!compact && (
        <button
          type="submit"
          disabled={status === 'submitting'}
          className="min-h-11 w-full rounded-md bg-civic-navy px-4 py-2.5 font-medium text-white transition-colors hover:bg-civic-navy-light focus:outline-none focus:ring-2 focus:ring-civic-navy focus:ring-offset-2 disabled:cursor-wait disabled:opacity-50 cursor-pointer"
        >
