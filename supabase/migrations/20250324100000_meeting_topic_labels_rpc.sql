-- Migration 056: Add top_topic_labels to get_meeting_counts RPC
-- Aggregates topic_label from agenda_items per meeting, returns top labels with counts.
-- Must DROP first because return type changed (added topic_labels column).
