...
DROP POLICY IF EXISTS "Public read" ON form700_filings;
CREATE POLICY "Public read" ON form700_filings
  FOR SELECT TO public USING (true);

-- economic_interests: public read
ALTER TABLE economic_interests ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Public read" ON economic_interests;
CREATE POLICY "Public read" ON economic_interests
  FOR SELECT TO public USING (true);
