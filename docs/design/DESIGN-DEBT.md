...
| DD-004 | U11, A5 | Shared navigation at 640px | P1 | The desktop navigation activates at the `sm` breakpoint but needs about 1,088px, causing horizontal page overflow at 640px (the required 200% zoom simulation). The Richmond 101 article itself remains within the viewport; the shared navigation is the overflow source. | Final UX polish before Richmond 101 public-graduation review. | Open | — |
