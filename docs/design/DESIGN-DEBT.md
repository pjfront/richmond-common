...
| DD-004 | U11, A5 | Shared navigation at 640px | P1 | The desktop navigation activated at the `sm` breakpoint but needed about 1,088px, causing horizontal page overflow at 640px (the required 200% zoom simulation). The Richmond 101 article itself remained within the viewport; the shared navigation was the overflow source. | Final UX polish before Richmond 101 public-graduation review. | Resolved | 2026-08-24 |
| DD-005 | U11, A5 | SourceBadge exact-source link | P1 | The trust-critical exact-source link rendered only 20px high, below the 44px minimum touch target. The link now uses a 44px minimum height while preserving the compact visual treatment. | PR #115 accessibility review. | Resolved | 2026-08-24 |
